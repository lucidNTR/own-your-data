...
<div class="company-section">
	<h2>Google <span class="rating rating-c">C</span></h2>
...
<div class="company-section">
	<h2>Meta <span class="rating rating-d">D</span></h2>
	<ul class="service-list">
		<li class="service-item">
...
<div class="company-section">
	<h2>Amazon <span class="rating rating-e">E</span></h2>
	<ul class="service-list">
		<li class="service-item">
...
<div style="margin-top: 3rem;">
	<a href="/" class="btn">Return to Mission</a>
</div>
